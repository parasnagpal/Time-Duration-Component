...
class App extends React.Component{
  ...
  handleSleepChange(e){
    this.setState({
      sleep:this.fetchTime(e.target.value)
    })
  }

  handleWakeChange(e){
    this.setState({
      wake:this.fetchTime(e.target.value)
    })
  }

  calculateStrokeLength(){
    let l=Math.abs(this.state.sleep-this.state.wake);
    let r=117.5;
    return 2*Math.PI*r*l/12
  }
                  ...
                  <div class="d-flex justify-content-center clock">
                      ...
                      <div class="boundary-container">
                          <svg viewBox="0 0 240 240">
                              <circle cx="120" cy="120" r="117.5" stroke="#6c757d" stroke-width="5" fill="none"/>
                          </svg>
                      </div>
                      <div class="boundary-container">
                          <svg viewBox="0 0 240 240" >
                              <circle cx="120" cy="120" r="117.5" stroke="#ffc107" stroke-width="5" fill="none" class="duration" id="duration"/>
                          </svg>
                      </div>
                  </div>
                </div>
